  ...
  return (
    <section className="wrap">
      <div className="method">
        ...
        <h3>Axis 1 &mdash; FODMAP rating (prebiotic-gated)</h3>
        <p>The rating hinges on one distinction: <b>purified prebiotics</b> (fructooligosaccharides/FOS, inulin, chicory root) versus <b>whole legumes</b> (peas, lentils, chickpeas). Purified prebiotics are added specifically to ferment &mdash; they are potent substrate for a small-intestinal overgrowth even in tiny amounts. Whole legumes are a milder, slower-fermenting concern. So the scale gates on the former:</p>
        <div className="scale">
          <div className="scale-row"><div className="scale-tag" style={{ background: 'var(--excellent)' }}>Excellent</div><div className="scale-desc">Nothing fermentable. No prebiotics, no legumes.</div></div>
          <div className="scale-row"><div className="scale-tag" style={{ background: 'var(--good)' }}>Good</div><div className="scale-desc">Only trace fermentable content (e.g. pea starch, a yeast-derived MOS).</div></div>
          ...
          <div className="scale-row"><div className="scale-tag" style={{ background: 'var(--poor)' }}>Poor</div><div className="scale-desc">Contains a purified prebiotic (FOS/inulin/chicory), or a heavy legume load.</div></div>
          <div className="scale-row"><div className="scale-tag" style={{ background: 'var(--avoid)' }}>Avoid</div><div className="scale-desc">Purified prebiotic plus a heavy fermentable load.</div></div>
        </div>
        <div className="callout">The guiding principle: <b>if a food is even a candidate for a sensitive gut, it isn&rsquo;t a true &ldquo;Poor.&rdquo;</b> Whole legumes alone never push past Moderate; it takes an added purified prebiotic to sink a food.</div>
